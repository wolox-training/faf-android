...
class HomeViewPagerActivity @Inject constructor() : WolmoActivity<ActivityLoginBinding>() {
    ...
    companion object {
        fun start(context: Context) = context.jumpTo(HomeViewPagerActivity::class.java)
    }
}