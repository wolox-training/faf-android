...
import ar.com.wolox.android.example.ui.hompage.HomePageModule
...
@Component(dependencies = [NetworkingComponent::class],
        modules = [AndroidSupportInjectionModule::class, DefaultModule::class, ContextModule::class,
            SignUpModule::class, HomePageModule::class, LoginModule::class, ExampleModule::class, ViewPagerActivityModule::class])
