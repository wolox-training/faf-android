...
import ar.com.wolox.android.example.ui.viewpager.homepageviewpager.HomePageViewPagerActivity
...
class LoginFragment private constructor() : WolmoFragment<FragmentLoginBinding, LoginPresenter>(), LoginView {
    ...
    override fun goToHomePage() = HomePageViewPagerActivity.start(requireContext())
